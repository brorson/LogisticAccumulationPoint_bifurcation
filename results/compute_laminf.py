...
if (__name__ == "__main__"):
    ...
    # by hand.
    #filename2 = "results_250_-50.txt"
    #filename2 = "results_300_-50.txt"
    #filename1 = "results_500_-100.txt"
    #filename2 = "results_500_-100.txt"
    #filename2 = "results_750_-150.txt"
    #filename2 = "results_1000_-200.txt"
    #filename2 = "results_1500_-300.txt"
    #filename2 = "results_superstable_prec150.txt"
    #filename2 = "results_superstable_prec160.txt"
    #filename2 = "results_superstable_prec320.txt"
    #filename2 = "results_superstable_prec340.txt"
    #filename2 = "results_superstable_prec500.txt"
    filename2 = "results_superstable_prec600.txt"
    #filename2 = "results_superstable_prec1000.txt"
    ...
    #print("-----------")
    #print("compare final x1 with final x2:")    
    #seq.compare_lambdas(x1[-1], x2[-1])
    ...
    #print("len(x1) = "+str(len(x1)))
    #ax1 = seq.compute_lambdainf_aitken(x1)
    #M = len(ax1)
    #while (M > 2):
    #    ax1 = seq.compute_lambdainf_aitken(ax1)
    #    M = len(ax1)
    ...
    #print("-----------")
    # Compare two results to verify they match to within 
    # some number of digits.
    #print("compare ax1 with ax2:")    
    #seq.compare_lambdas(ax1[-1], ax2[-1])
